# Generated by Django 5.0.3 on 2024-04-05 05:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default='null', max_length=150)),
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='addreview.brand')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('slug', models.SlugField(default='null', max_length=150)),
                ('phone_model', models.ManyToManyField(to='addreview.model')),
            ],
        ),
    ]
